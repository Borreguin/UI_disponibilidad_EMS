          ...
          <div className="page-content">
            <Form.Group as={Row} className="sc-search">
              ...
              >
                  ...
                  <input className="date-input" value={this.state.ini_date_str} onChange={(e) => this.onChangeDate(e, "ini_date")}/>{" "}
                  <input className="date-input" value={this.state.end_date_str} onChange={(e) => this.onChangeDate(e, "end_date")}/>
                  <div
                    className={
