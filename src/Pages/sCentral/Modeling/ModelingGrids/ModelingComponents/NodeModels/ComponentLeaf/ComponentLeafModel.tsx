...
export interface ComponentLeafParams {
...
export class ComponentLeafModel extends NodeModel<
ComponentLeafParams & NodeModelGenerics
> {
  data: Node;
  handle_msg: Function;
  ...
  constructor(params: {
    ...
    super({ type: "ComponenteLeaf", id: params.node.public_id });
