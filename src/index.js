...
import SRModelingRTUsOrTags from './Pages/sRemoto/Modeling/mp_SRModelingRTUsOrTags';
...
const routing = (
  <Router>
    ...
    <Route exact path="/Pages/sRemoto/SRmodelingTags" component={SRModelingRTUsOrTags}/>
