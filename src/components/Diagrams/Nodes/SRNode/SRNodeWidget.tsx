...
export interface SRNodeWidgetProps {
	node: SRNodeModel;
 ...
 */
export class SRNodeWidget extends React.Component<SRNodeWidgetProps> {
	
	bck_node: SRNodeModel;		// original node
	node: SRNodeModel;  		// edited node
	state = {
		edited: false
	}
	...
	_addElement = () => {
		...
		this.props.node.addPort(new SRPortModel(PortModelAlignment.TOP));
